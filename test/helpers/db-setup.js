...
export function buildTestData() {
  return {
    ...
    permissions: [
      { source_type: 'Profile', source_id: 'Admin', permission_type: 'ObjectPermission', permission_name: 'Account.Create', permission_value: 'true' },
      { source_type: 'Profile', source_id: 'Admin', permission_type: 'ObjectPermission', permission_name: 'Account.Delete', permission_value: 'true' },
      { source_type: 'Profile', source_id: 'Admin', permission_type: 'ObjectPermission', permission_name: 'Account.Edit', permission_value: 'true' },
      { source_type: 'Profile', source_id: 'Admin', permission_type: 'ObjectPermission', permission_name: 'Account.Read', permission_value: 'true' },
      { source_type: 'Profile', source_id: 'Admin', permission_type: 'ObjectPermission', permission_name: 'Account.ModifyAll', permission_value: 'true' },
      { source_type: 'Profile', source_id: 'Admin', permission_type: 'ObjectPermission', permission_name: 'Account.ViewAll', permission_value: 'true' },
      { source_type: 'Profile', source_id: 'Admin', permission_type: 'FieldPermission', permission_name: 'Account.Industry', permission_value: 'Edit' },
      { source_type: 'Profile', source_id: 'Admin', permission_type: 'UserPermission', permission_name: 'ManageUsers', permission_value: 'true' },

      { source_type: 'Profile', source_id: 'Standard', permission_type: 'ObjectPermission', permission_name: 'Account.Read', permission_value: 'true' },

      { source_type: 'PermissionSet', source_id: 'SalesOps', permission_type: 'ObjectPermission', permission_name: 'Account.Create', permission_value: 'true' },
      { source_type: 'PermissionSet', source_id: 'SalesOps', permission_type: 'ObjectPermission', permission_name: 'Account.Edit', permission_value: 'true' },
      { source_type: 'PermissionSet', source_id: 'SalesOps', permission_type: 'ObjectPermission', permission_name: 'Account.Delete', permission_value: 'true' },
      { source_type: 'PermissionSet', source_id: 'SalesOps', permission_type: 'ObjectPermission', permission_name: 'Account.Read', permission_value: 'true' },
      { source_type: 'PermissionSet', source_id: 'SalesOps', permission_type: 'FieldPermission', permission_name: 'Account.Industry', permission_value: 'Edit' },
      { source_type: 'PermissionSet', source_id: 'SalesOps', permission_type: 'CustomPermission', permission_name: 'ViewDashboard', permission_value: 'true' },

      { source_type: 'PermissionSet', source_id: 'MarketingUser', permission_type: 'ObjectPermission', permission_name: 'Account.Read', permission_value: 'true' },
      { source_type: 'PermissionSet', source_id: 'MarketingUser', permission_type: 'FieldPermission', permission_name: 'Account.Industry', permission_value: 'Read' },
      { source_type: 'PermissionSet', source_id: 'MarketingUser', permission_type: 'CustomPermission', permission_name: 'SendEmails', permission_value: 'true' },
    ],
    userAssignments: [
...
export function seedSourceDatabase() {
  return seedDatabase();
}

export function seedTargetDatabase() {
  const db = new Database(':memory:');
  ...
  const insertPSG = db.prepare('INSERT INTO permission_set_groups (id, full_name, label, status) VALUES (?, ?, ?, ?)');
  const inactiveBundleOnly = data.permissionSetGroups.filter(psg => psg.id !== 'SalesBundle');
  inactiveBundleOnly.forEach(psg => insertPSG.run(psg.id, psg.full_name, psg.label, psg.status));
  ...
  const insertPermission = db.prepare('INSERT INTO permissions (source_type, source_id, permission_type, permission_name, permission_value) VALUES (?, ?, ?, ?, ?)');
  targetPermissions.forEach(p => insertPermission.run(p.source_type, p.source_id, p.permission_type, p.permission_name, p.permission_value));
